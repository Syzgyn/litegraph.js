...
describe("contextMenuCompat", () => {
  ...
  beforeEach(() => {
    ...
    // Create mock canvas
    mockCanvas = Object.create(LGraphCanvas.prototype) as LGraphCanvas
  ...
  describe("install", () => {
    test("should install compatibility layer on prototype", () => {
    ...
    test("should detect monkey patches and warn", () => {
      const methodName = "getCanvasMenuOptions"
    ...
    test("should only warn once per unique function", () => {
      const methodName = "getCanvasMenuOptions"
      const warnSpy = vi.spyOn(console, "warn")
  ...
  describe("extractLegacyItems", () => {
    ...
    test("should extract items added by monkey patches", () => {
    ...
    test("should detect replaced items as additions and warn about removed items", () => {
      const warnSpy = vi.spyOn(console, "warn")
    ...
    test("should handle multiple items with undefined content correctly", () => {
  ...
  describe("integration", () => {
    ...
    test("should work with multiple extensions patching", () => {
    ...
    test("should extract legacy items only once even when called multiple times", () => {
    ...
    test("should not extract items from registered wrapper methods", () => {
      // Setup base method with cached item
      LGraphCanvas.prototype.getCanvasMenuOptions = function () {
        return [integrationBaseItem]
      }
    ...
    test("should extract legacy items even when a wrapper is registered but not active", () => {
      // Setup base method with cached item
      LGraphCanvas.prototype.getCanvasMenuOptions = function () {
        return [integrationBaseItem]
      }

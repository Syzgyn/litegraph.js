...
/** lastNodeId near MAX_NODE_ID with duplicate subgraph node IDs — must throw. */
export const nodeIdSpaceExhausted = {
  id: "cccccccc-cccc-4ccc-8ccc-cccccccccccc",
  version: 1,
  revision: 0,
  state: { lastNodeId: 99_999_999, lastLinkId: 10, lastGroupId: 0, lastRerouteId: 0 },
  nodes: [
    {
      id: 102,
    ...
    { id: 100_000_000, type: "dummy", pos: [600, 0], size: [100, 50], flags: {}, order: 2, mode: 0 },
  ],
  definitions: {
    subgraphs: [
      {

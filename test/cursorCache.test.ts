...
describe("createCursorCache", () => {
  test("should only write to DOM when cursor value changes", () => {
  ...
  test("should write to DOM when cursor value differs", () => {
    const { element, setter } = createMockElement()
    const setCursor = createCursorCache(element)
  ...
  test("should skip repeated values interspersed with changes", () => {
    const { element, setter } = createMockElement()
    const setCursor = createCursorCache(element)
